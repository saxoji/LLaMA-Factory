...
register_model_group(
    models={
        ...
        "Gemma-2-27B-Migtissera": {
            DownloadSource.DEFAULT: "migtissera/Tess-v2.5-Gemma-2-27B-alpha",
        },
    },
    template="gemma",
)
...
register_model_group(
    models={
        ...
        "Llama-3.1-8B-Nvidia-Instruct": {
            DownloadSource.DEFAULT: "nvidia/OpenMath2-Llama3.1-8B",
        },
        ...
        "Llama-3.2-3B-Linkbricks-Korean-cpt": {
            DownloadSource.DEFAULT: "Saxo/Linkbricks-Llama3.2-Korean-cpt-3b",
        },
    },
    template="llama3",
)
...
register_model_group(
    models={
        "Llama-3.2-3B-unsloth-Instruct": {
            DownloadSource.DEFAULT: "unsloth/Llama-3.2-3B-Instruct",
        },
    },
    template="alpaca",
)
...
register_model_group(
    models={
        ...
        "Mistral-22B-Instruct-2409": {
            DownloadSource.DEFAULT: "mistralai/Mistral-Small-Instruct-2409",
        },
    },
...
register_model_group(
    models={
        ...
        "Nous-Hermes-3-Llama3.1-8b-Korean-cpt": {
            DownloadSource.DEFAULT: "Saxo/Linkbricks-Horizon-AI-Nous-Hermes-3-Llama3.1-Korean-cpt-8b",
        },
        "Nous-Hermes-3-Llama3.1-Linkbricks-Korean-Pro-8b": {
            DownloadSource.DEFAULT: "Saxo/Linkbricks-Horizon-AI-Korean-Pro-8B",
        },
